...
from entropy import count_empty
...
for n,src_image_name in enumerate(img_filenames):
    ...
    for g in range(patches_per_image):
        ...
        if sav < 100:
            ...
            sav += 1
        flattened = numpy.array(map(lambda px: px/256, patch_img.getdata()),dtype=numpy.float32, copy=True)
