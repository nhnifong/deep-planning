...
I can make the algorithms compete against eachother or against a simple greedy algorithm that simulates all possible moves forward with all available computing power.
